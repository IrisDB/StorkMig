...
SplitGPSBursts <- function(DataFrame,MaxTimeDiff=10,MinBurstLength=120){ # Start function SplitGPSBursts
	...
	data.ind <- split(DataFrame,DataFrame$tag.local.identifier)
	...
	BurstData2$BurstID<-paste0(BurstData2$tag.local.identifier,"_",BurstData2$Bno)

	DataFrame$BurstID<-BurstData2[match(DataFrame$UniqueNumber,BurstData2$UniqueNumber),"BurstID"]
